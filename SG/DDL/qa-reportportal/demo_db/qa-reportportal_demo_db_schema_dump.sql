...
--
-- Name: demo_test5; Type: TABLE; Schema: public; Owner: sakshi
--

CREATE TABLE public.demo_test5 (
    id character(14) NOT NULL
);


ALTER TABLE public.demo_test5 OWNER TO sakshi;

--
-- Name: demo_test6; Type: TABLE; Schema: public; Owner: sakshi
--

CREATE TABLE public.demo_test6 (
    id character(14) NOT NULL
);


ALTER TABLE public.demo_test6 OWNER TO sakshi;

--
-- Name: demo_users; Type: TABLE; Schema: public; Owner: sakshi
--
...
ALTER TABLE public.demo_users OWNER TO sakshi;

--
-- Name: demo_users_id_seq; Type: SEQUENCE; Schema: public; Owner: sakshi
--
...
ALTER TABLE public.demo_users_id_seq OWNER TO sakshi;

--
-- Name: demo_users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: sakshi
--
...
--
-- Name: grafana_outbox; Type: TABLE; Schema: public; Owner: sakshi
--

CREATE TABLE public.grafana_outbox (
    id character varying(20) NOT NULL,
    entity_id character varying(20),
    entity_type character varying(30),
    payload_name character varying(50),
    payload json,
    priority integer,
    is_deleted boolean,
    retry_count integer,
...
ALTER TABLE public.grafana_outbox OWNER TO sakshi;

--
-- Name: iss_58567; Type: TABLE; Schema: public; Owner: sakshi
--

CREATE TABLE public.iss_58567 (
    id character(14) NOT NULL
);


ALTER TABLE public.iss_58567 OWNER TO sakshi;

--
-- Name: iss_585672; Type: TABLE; Schema: public; Owner: sakshi
--

CREATE TABLE public.iss_585672 (
    id character(14) NOT NULL
);


ALTER TABLE public.iss_585672 OWNER TO sakshi;
...
--
-- Name: demo_users id; Type: DEFAULT; Schema: public; Owner: sakshi
--
...
--
-- Name: demo_test5 demo_test5_pkey; Type: CONSTRAINT; Schema: public; Owner: sakshi
--

ALTER TABLE ONLY public.demo_test5
    ADD CONSTRAINT demo_test5_pkey PRIMARY KEY (id);


--
-- Name: demo_test6 demo_test6_pkey; Type: CONSTRAINT; Schema: public; Owner: sakshi
--

ALTER TABLE ONLY public.demo_test6
    ADD CONSTRAINT demo_test6_pkey PRIMARY KEY (id);


--
-- Name: demo_users demo_users_email_key; Type: CONSTRAINT; Schema: public; Owner: sakshi
--
...
--
-- Name: demo_users demo_users_pkey; Type: CONSTRAINT; Schema: public; Owner: sakshi
--
...
--
-- Name: grafana_outbox grafana_outbox_pkey; Type: CONSTRAINT; Schema: public; Owner: sakshi
--

ALTER TABLE ONLY public.grafana_outbox
    ADD CONSTRAINT grafana_outbox_pkey PRIMARY KEY (id);


--
-- Name: iss_585672 iss_585672_pkey; Type: CONSTRAINT; Schema: public; Owner: sakshi
--

ALTER TABLE ONLY public.iss_585672
    ADD CONSTRAINT iss_585672_pkey PRIMARY KEY (id);


--
-- Name: iss_58567 iss_58567_pkey; Type: CONSTRAINT; Schema: public; Owner: sakshi
--

ALTER TABLE ONLY public.iss_58567
    ADD CONSTRAINT iss_58567_pkey PRIMARY KEY (id);
